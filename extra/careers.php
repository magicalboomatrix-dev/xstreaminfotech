	...
	<div class="hero-section inner-hero">
		<div class="hero-absolute">
         ...
         <div class="container">
            <div class="rows">
			<h1>
			<span>Careers at SIXGUN</span>  <br>
			</h1>
			</div>
			<div class="info">
			<p>We’re always on the lookout for ambitious, experienced, and hard-working individuals who are passionate <br> about digital marketing. If you live and breathe SEO, are <br> enamoured by the power of social media, or are fascinated by how data can drive decision making, we want to hear from you.</p>
			</div>
		</div>
	</div>
...
<!-- Our_Philosophy_section end -->
      ...
      <div class="home_team_section inner-casestudy-section">
		 ...
		 <div class="col-sm-5">
		 <div class="info">
            <h2>Contact us now to get your local <br> SEO journey underway</h2>
			<p>Become the business all the locals turn to, with SIXGUN. Call us on 1300 127 361 to speak with a friendly member of our team and we’ll be happy to provide all the answers you need.</p>
			<p>Regardless of your industry, SIXGUN’s team of digital marketing experts can tailor a solution for your business. We’ve made it our mission to stay ahead of the competition and offer Melbourne’s most advanced and up-to-date search engine optimisation services, both for local results and international traffic. Discover more today and start your digital marketing journey with SIXGUN at the wheel.</p>
         </div>
         </div>
         </div>
         </div>
		 ...
		 <div class="info">
			...
			<div class="elementor-widget-container">
				...
				<p>SIXGUN can provide local 
					<a href="https://sixgun.com.au/seo/">SEO services in Melbourne</a>, 
